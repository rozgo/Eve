...
public class Table {
	...
	public static Table Get (string name) {
		Table table;
		if (tables.TryGetValue(name, out table)) {return table;}
		table = new Table();
		table.name = name;
		tables[name] = table;
		return table;
...
public class Field {
	...
	public virtual string Encode () {return DebugValue;}
	...
	public class Number : Field {
		float value = 0;
		public void Set (float value) {this.value = value; OnDidSet();}
		public float Get () {return value;}
		public override string Encode () {return value.ToString("0.0000");}
	}
	
	[System.Serializable]
	public class String : Field {
		string value = string.Empty;
		public void Set (string value) {this.value = value; OnDidSet();}
		public string Get () {return value;}
		public override string Encode () {return value;}
	}
}
